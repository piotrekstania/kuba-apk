...
| **Wykaz działki na kartce pionowej, po dwa wiersze na działkę** (decyzja z 19.08.2026, zmiana wcześniejszej) | poziomo mieściło się trzynaście kolumn: L.p. plus sześć na stan dotychczasowy i sześć na nowy, **obok siebie** — żeby porównać „przed” z „po”, trzeba było wodzić okiem przez pół szerokiej kartki, a nagłówki łamały się na trzy linijki. Teraz kolumn jest osiem, a stany leżą jeden pod drugim: `{%tr for %}` powtarza **parę** wierszy, „Dotychczasowy” nad „Nowym”, L.p. scalone pionowo przez oba. Każda kolumna wyszła przy tym **szersza** niż w poziomej wersji (pilnuje tego test). Działki oddziela kreska 2,25 pt, wewnątrz pary zostaje 0,5 pt. Dwie rzeczy, o które to się rozbiło przy budowie: wcięcie bloku podpisu było dobrane pod kartkę poziomą (na pionowej podpis łamał się po literze), a tabela szersza od szerokości tekstu **choćby o 23 twipy** ucieka na drugą stronę — suma kolumn musi się zgadzać co do twipa. Konwersję zrobił jednorazowo `narzedzia/utworz_wykaz_dzialki_pionowy.py` |
...
(od 19.08.2026 też **pionowy**, po dwa wiersze na działkę). Wygląd sprawdzony na Wordzie
